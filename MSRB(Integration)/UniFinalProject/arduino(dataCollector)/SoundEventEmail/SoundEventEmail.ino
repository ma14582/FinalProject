...
inserted in an array and the average is calculated every time a new data is 
   ...
   average = total / numReadings;    // calculate the average
    ...
    if(average>=threshold){
      if (count == 0) {
        ...
        sendEmailToUser();
        count = 1;        // Set the counter to 1 in order to avoid more sound until the last one finishes
      }
...
// Calculate the average for the elements in the array every time a new one is inserted
