/*
 ==============================================================================================
 This class implements all the methods to manipulate the android database such as getting
 the result from it in a cursor type according to a service, converting cursor result from
 rawQuery to String and inserting values from server in database if they don't exist.
 ==============================================================================================
*/
...
public class DatabaseAndroidActivity {
    ...
    // DatabaseAndroidActivity Constructor
    public DatabaseAndroidActivity(DatabaseHelper myDb) {
        this.myDb = myDb;
    }

    // Getting events from android database depending on the service
