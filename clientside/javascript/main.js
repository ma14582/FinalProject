...
function printEvent(result) {
    $.each(result.events, function (key, value) {
        if (value.event === "bark") {
            $('#eventList').append('<p>' + ' barking on ' + '<span class="blue">' + value.date + '</span>' + ' at ' + '<span class="blue">' + value.time + '</span>' + '</p>');
        }
        if (value.event === "movement") {
            $('#eventList').append('<p>' + ' moving on ' + '<span class="red">' + value.date + '</span>' + ' at ' + '<span class="red">' + value.time + '</span>' + '</p>');
        }
